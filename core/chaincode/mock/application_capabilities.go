...
func (fake *ApplicationCapabilities) LeanFormatEnabled() bool {
	...
	fake.leanFormatEnabledMutex.Unlock()
	if stub != nil {
		return stub()
	}
	if specificReturn {
...
func (fake *ApplicationCapabilities) LeanFormatEnabledCallCount() int {
	fake.leanFormatEnabledMutex.RLock()
	defer fake.leanFormatEnabledMutex.RUnlock()
	return len(fake.leanFormatEnabledArgsForCall)
}

func (fake *ApplicationCapabilities) LeanFormatEnabledCalls(stub func() bool) {
	fake.leanFormatEnabledMutex.Lock()
	defer fake.leanFormatEnabledMutex.Unlock()
	fake.LeanFormatEnabledStub = stub
}

func (fake *ApplicationCapabilities) LeanFormatEnabledReturns(result1 bool) {
	fake.leanFormatEnabledMutex.Lock()
	defer fake.leanFormatEnabledMutex.Unlock()
	fake.LeanFormatEnabledStub = nil
	fake.leanFormatEnabledReturns = struct {
		result1 bool
	}{result1}
}

func (fake *ApplicationCapabilities) LeanFormatEnabledReturnsOnCall(i int, result1 bool) {
	fake.leanFormatEnabledMutex.Lock()
	defer fake.leanFormatEnabledMutex.Unlock()
	fake.LeanFormatEnabledStub = nil
	if fake.leanFormatEnabledReturnsOnCall == nil {
		fake.leanFormatEnabledReturnsOnCall = make(map[int]struct {
			result1 bool
		})
	}
	fake.leanFormatEnabledReturnsOnCall[i] = struct {
		result1 bool
	}{result1}
}
