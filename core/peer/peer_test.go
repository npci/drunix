...
import (
	...
	configtxtest "github.com/npci/drunix/common/configtx/test"
	...
	ledgermocks "github.com/npci/drunix/core/ledger/mock"
...
func TestInitialize(t *testing.T) {
	...
	peerInstance.Initialize(
		...
		nil,
		runtime.NumCPU(),
		plugin.MapBasedMapperAdapter(map[string]validation.PluginFactoryAdapter{}),
	)
