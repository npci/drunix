...
import (
	...
	protoutil "github.com/npci/drunix/protoutil"
...
// DRUNIX : not implemented history db changes for lite format
func (d *DB) CommitLostLiteBlock(blockAndPvtdata *ledger.BlockAndPvtData) error {
	return nil
}
