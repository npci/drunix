...
import (
	...
	"github.com/npci/drunix/core/chaincode/implicitcollection"
	"github.com/npci/drunix/core/ledger"
	"github.com/npci/drunix/core/ledger/cceventmgmt"
	"github.com/npci/drunix/core/ledger/confighistory/confighistorytest"
	"github.com/npci/drunix/core/ledger/internal/version"
	kvledgermock "github.com/npci/drunix/core/ledger/kvledger/mock"
	"github.com/npci/drunix/core/ledger/kvledger/msgs"
	"github.com/npci/drunix/core/ledger/kvledger/txmgmt/statedb/statecouchdb"
	"github.com/npci/drunix/core/ledger/mock"
...
func TestGenerateSnapshotErrors(t *testing.T) {
	...
	t.Run("block store returns error", func(t *testing.T) {
		...
		require.Contains(t, errStackTrace, "github.com/npci/drunix/common/ledger/blkstorage")
	})
	...
	t.Run("config history mgr returns error", func(t *testing.T) {
		...
		errStackTrace := fmt.Sprintf("%+v", err)
		require.Contains(t, errStackTrace, "internal leveldb error while obtaining db iterator")
		require.Contains(t, errStackTrace, "github.com/npci/drunix/core/ledger/confighistory")
	})
