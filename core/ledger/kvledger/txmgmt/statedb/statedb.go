...
type KVersionStoreHandler interface {
	// GetState gets the value for given namespace and key. Used to get the commited version for MVCC
	GetState(namespace string, key string) (*VersionedValue, error)
	// ApplyOrdererUpdates applies the batch to the underlying orderer db.
	ApplyOrdererUpdates(updates map[string]*VersionMVCC) error
	...
	// GetKeyVersion gets the version for given namespace and key. For a chaincode, the namespace corresponds to the chaincodeId
	GetKeyVersion(namespace string, key string) (*version.Height, error)
}
...
type UpdateBatch struct {
	...
	// DRUNIX:
	// To handle sql schema updates on chaincode commit
	SchemaUpdates []string
}

// NewUpdateBatch constructs an instance of a Batch
func NewUpdateBatch() *UpdateBatch {
	return &UpdateBatch{false, make(map[string]*nsUpdates), nil}
}
