...
import (
	...
	"github.com/npci/drunix/core/ledger/confighistory"
	"github.com/npci/drunix/core/ledger/internal/version"
	"github.com/npci/drunix/core/ledger/kvledger/bookkeeping"
	"github.com/npci/drunix/core/ledger/kvledger/history"
	"github.com/npci/drunix/core/ledger/kvledger/txmgmt/privacyenabledstate"
	"github.com/npci/drunix/core/ledger/kvledger/txmgmt/txmgr"
	"github.com/npci/drunix/core/ledger/kvledger/txmgmt/validation"
	"github.com/npci/drunix/core/ledger/pvtdatapolicy"
	...
	for blockNumber := firstBlockNum; blockNumber <= lastBlockNum; blockNumber++ {
		...
		for _, r := range recoverables {
			if protoutil.IsConfigBlock(blk) || !protoutil.IsLiteBlock(blk) {
				...
				if err := r.CommitLostLiteBlock(blockAndPvtdata); err != nil {
					return err
				}
			}
		}
