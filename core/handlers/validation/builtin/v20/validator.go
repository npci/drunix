...
type StateBasedValidator interface {
	...
	ValidateLtx(cc string, blockNum, txNum uint64, rwset *common.TxReadWriteSet, prp *common.ProposalResponsePayload,
		ep []byte, endorsements []*common.Endorsement) commonerrors.TxValidationError
