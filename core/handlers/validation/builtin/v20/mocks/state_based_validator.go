...
import (
	...
	errors "github.com/npci/drunix/common/errors"
...
func (_m *StateBasedValidator) ValidateLtx(cc string, blockNum uint64, txNum uint64, rwset *common.TxReadWriteSet, prp *common.ProposalResponsePayload, ep []byte, endorsements []*common.Endorsement) errors.TxValidationError {
	ret := _m.Called(cc, blockNum, txNum, rwset, prp, ep, endorsements)

	var r0 errors.TxValidationError
	if rf, ok := ret.Get(0).(func(string, uint64, uint64, *common.TxReadWriteSet, *common.ProposalResponsePayload, []byte, []*common.Endorsement) errors.TxValidationError); ok {
		r0 = rf(cc, blockNum, txNum, rwset, prp, ep, endorsements)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(errors.TxValidationError)
