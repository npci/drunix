...
import (
	...
	mocks2 "github.com/npci/drunix/bccsp/mocks"
	"github.com/npci/drunix/bccsp/sw/mocks"
...
func TestSign(t *testing.T) {
	...
	value, err := csp.Sign(expectedKey, expectedDigest, expectedOpts)
