...
-	**Image Dockerfile**:  
	[Dockerfile location](https://github.com/npci/drunix/blob/main/images/peer/Dockerfile)

-	**Source of this description**:  
	[Fabric github repository](https://github.com/npci/drunix/blob/main/images/peer/README.md)
...
Hyperledger Fabric is licensed under the [Apache License, version 2.0](https://github.com/npci/drunix/blob/main/LICENSE).
