...
// ConfigEventsRequest contains details of the config events that the caller wants to receive.
type ConfigEventsRequest struct {
	// Identifier of the peer this request sent from.
...
func (m *ConfigEventsRequest) Reset()         { *m = ConfigEventsRequest{} }
func (m *ConfigEventsRequest) String() string { return proto.CompactTextString(m) }
func (*ConfigEventsRequest) ProtoMessage()    {}
func (*ConfigEventsRequest) Descriptor() ([]byte, []int) {
...
var xxx_messageInfo_ConfigEventsRequest proto.InternalMessageInfo

func (m *ConfigEventsRequest) GetPeerId() string {
	if m != nil {
		return m.PeerId
	}
	return ""
...
func (m *ConfigEventsRequest) GetChannelId() string {
	if m != nil {
		return m.ChannelId
	}
	return ""
...
// ConfigEventsResponse returns config events from block commited by the peer.
type ConfigEventsResponse struct {
	// Identifier of the channel in which config transaction was committed.
	ChannelId            string   `protobuf:"bytes,1,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *ConfigEventsResponse) Reset()         { *m = ConfigEventsResponse{} }
func (m *ConfigEventsResponse) String() string { return proto.CompactTextString(m) }
func (*ConfigEventsResponse) ProtoMessage()    {}
func (*ConfigEventsResponse) Descriptor() ([]byte, []int) {
...
var xxx_messageInfo_ConfigEventsResponse proto.InternalMessageInfo

func (m *ConfigEventsResponse) GetChannelId() string {
	if m != nil {
		return m.ChannelId
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*ConfigEventsRequest)(nil), "gateway.ConfigEventsRequest")
	proto.RegisterType((*ConfigEventsResponse)(nil), "gateway.ConfigEventsResponse")
}
...
var fileDescriptor_285396c8df15061f = []byte{
	...
	,
}
...
type GatewayClient interface {
	...
	// The ConfigEvents service supplies a stream of responses, each containing events
	// for a config transaction or approve/commit chaincode transaction.
	ConfigEvents(ctx context.Context, in *ConfigEventsRequest, opts ...grpc.CallOption) (Gateway_ConfigEventsClient, error)
}
...
func (c *gatewayClient) ConfigEvents(ctx context.Context, in *ConfigEventsRequest, opts ...grpc.CallOption) (Gateway_ConfigEventsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Gateway_serviceDesc.Streams[1], "/gateway.Gateway/ConfigEvents", opts...)
	if err != nil {
		return nil, err
	}
	x := &gatewayConfigEventsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Gateway_ConfigEventsClient interface {
	Recv() (*ConfigEventsResponse, error)
	grpc.ClientStream
}

type gatewayConfigEventsClient struct {
	grpc.ClientStream
}

func (x *gatewayConfigEventsClient) Recv() (*ConfigEventsResponse, error) {
	m := new(ConfigEventsResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type GatewayServer interface {
	...
	// The ConfigEvents service supplies a stream of responses, each containing events
	// for a config transaction or approve/commit chaincode transaction.
	ConfigEvents(*ConfigEventsRequest, Gateway_ConfigEventsServer) error
}
...
func _Gateway_ConfigEvents_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ConfigEventsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(GatewayServer).ConfigEvents(m, &gatewayConfigEventsServer{stream})
}

type Gateway_ConfigEventsServer interface {
	Send(*ConfigEventsResponse) error
	grpc.ServerStream
}

type gatewayConfigEventsServer struct {
	grpc.ServerStream
}

func (x *gatewayConfigEventsServer) Send(m *ConfigEventsResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _Gateway_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ConfigEvents",
			Handler:       _Gateway_ConfigEvents_Handler,
			ServerStreams: true,
		},
	},
