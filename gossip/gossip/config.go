...
type Config struct {
	...
	// DRUNIX:- LitePeerEnabled is the flag to distinguish between lite peer and committing peer
	LitePeerEnabled bool
	// DRUNIX:- CommittingPeerID is the peer ID of the committing peer associated with this lite peer
...
func (c *Config) loadConfig(endpoint string, certs *common.TLSCertificates, bootPeers ...string) error {
	...
	c.CommittingPeerID = viper.GetString("peer.committingpeer.id")
	return nil
}
