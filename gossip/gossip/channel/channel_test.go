...
import (
	...
	"github.com/npci/drunix/gossip/metrics/mocks"
...
func TestBadInput(t *testing.T) {
	...
	gc := NewGossipChannel(pkiIDInOrg1, orgInChannelA, cs, channelA, adapter, &joinChanMsg{},
		disabledMetrics, nil, false, "").(*gossipChannel)
...
func TestSelf(t *testing.T) {
	...
	configureAdapter(adapter)
	adapter.On("Gossip", mock.Anything)
	gc := NewGossipChannel(pkiID1, orgInChannelA, cs, channelA, adapter, jcm, disabledMetrics, nil, false, "")
...
func TestLeaveChannel(t *testing.T) {
	...
	gc := NewGossipChannel(common.PKIidType("p0"), orgInChannelA, cs, channelA, adapter, jcm, disabledMetrics, nil, false, "")
...
func TestChannelPeriodicalPublishStateInfo(t *testing.T) {
	...
	gc := NewGossipChannel(pkiIDInOrg1, orgInChannelA, cs, channelA, adapter, &joinChanMsg{}, disabledMetrics, nil, false, "")
...
func TestChannelPullAccessControl(t *testing.T) {
	...
	gc := NewGossipChannel(pkiIDInOrg1, orgInChannelA, cs, channelA, adapter, jcm, disabledMetrics, nil, false, "")
	gc.HandleMessage(&receivedMsg{PKIID: pkiIDInOrg1, msg: createStateInfoMsg(100, pkiIDInOrg1, channelA)})
...
func TestFilterForeignOrgLeadershipMessages(t *testing.T) {
	...
	gc := NewGossipChannel(pkiIDInOrg1, org1, cs, channelA, adapter, joinMsg, disabledMetrics, logger, false, "")
...
func TestMembershiptrackerStopWhenGCStops(t *testing.T) {
	...
	gc := NewGossipChannel(pkiID1, orgInChannelA, cs, channelA, adapter, jcm, disabledMetrics, logger, false, "")
