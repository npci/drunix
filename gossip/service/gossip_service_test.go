...
import (
	...
	gcomm "github.com/npci/drunix/gossip/comm"
	...
	"github.com/npci/drunix/internal/peer/gossip/mocks"
...
func (li *mockLedgerInfo) CommitLegacyLtx(blockAndPvtData *ledger.BlockAndPvtData, commitOpts *ledger.CommitOptions) error {
	panic("implement me")
}
