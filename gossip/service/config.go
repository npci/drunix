...
const (
	...
	litePeerLevelDBTransientPurgeInterval = time.Minute * 30
)
...
func (c *ServiceConfig) loadGossipConfig() {
	...
	c.LitePeerLevelDBTransientStorePurgeInterval = util.GetDurationOrDefault("peer.gossip.pvtData.litePeerLevelDBTransientPurgeInterval", litePeerLevelDBTransientPurgeInterval)
