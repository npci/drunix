...
import (
	...
	errors2 "github.com/npci/drunix/common/errors"
	...
	"github.com/npci/drunix/core/mocks/validator"
	...
	"github.com/npci/drunix/gossip/gossip/channel"
	"github.com/npci/drunix/gossip/metrics"
	"github.com/npci/drunix/gossip/privdata"
	capabilitymock "github.com/npci/drunix/gossip/privdata/mocks"
	"github.com/npci/drunix/gossip/protoext"
	"github.com/npci/drunix/gossip/state/mocks"
	gossiputil "github.com/npci/drunix/gossip/util"
...
func (mc *mockCommitter) CommitLegacyLtx(blockAndPvtData *ledger.BlockAndPvtData, commitOpts *ledger.CommitOptions) error {
	mc.Lock()
	m := mc.Mock
	mc.Unlock()
	m.Called(blockAndPvtData.Block)
...
func (mock *ramLedger) CommitLegacyLtx(blockAndPvtdata *ledger.BlockAndPvtData, commitOpts *ledger.CommitOptions) error {
	mock.Lock()
	defer mock.Unlock()
