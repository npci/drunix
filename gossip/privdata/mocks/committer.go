...
import ledger "github.com/npci/drunix/core/ledger"
...
func (_m *Committer) CommitLegacyLtx(blockAndPvtData *ledger.BlockAndPvtData, commitOpts *ledger.CommitOptions) error {
	ret := _m.Called(blockAndPvtData, commitOpts)
