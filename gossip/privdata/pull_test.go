...
import (
	...
	gmetricsmocks "github.com/npci/drunix/gossip/metrics/mocks"
	privdatacommon "github.com/npci/drunix/gossip/privdata/common"
	"github.com/npci/drunix/gossip/privdata/mocks"
...
func (gn *gossipNetwork) newPullerWithMetrics(metrics *metrics.PrivdataMetrics, id string, ps privdata.CollectionStore,
	...
	p := NewPuller(metrics, ps, g, &dataRetrieverMock{}, factory, "A", 10, false)
...
func TestPullerIntegratedWithDataRetreiver(t *testing.T) {
	...
	dataRetreiver := &counterDataRetreiver{PrivateDataRetriever: NewDataRetriever("testchannel", store, committer, false), numberOfCalls: 0}
