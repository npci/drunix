...
setAnchorPeer() {
  ORG=$1
  PEER=$2
  . scripts/setAnchorPeer.sh $ORG $PEER $CHANNEL_NAME 
}
...
infoln "Joining org1 CP to the channel..."
joinChannel 1 1	
infoln "Joining org1 LP to the channel..."
joinChannel 1 0 
infoln "Joining org2 CP to the channel..."
