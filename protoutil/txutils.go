...
func CreateSignedEnvelope(
	...
	return CreateSignedEnvelopeWithTLSBinding(txType, channelID, signer, dataMsg, msgVersion, epoch, nil, false)
}
...
func CreateSignedEnvelopeWithTLSBinding(
	...
	payloadChannelHeader.IsLitepeer = litePeerEnabled
	var err error
...
func GetOrComputeTxIDFromEnvelope(txEnvelopBytes []byte) (string, error) {
	...
	if txEnvelope.LeanEnv != nil {
		return txEnvelope.LeanEnv.TxId, nil
	}
