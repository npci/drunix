...
// DRUNIX : UnmarshalMetadata unmarshals bytes to a Metadata
func UnmarshalMetadata(encoded []byte) (*common.Metadata, error) {
	metadata := &common.Metadata{}
	err := proto.Unmarshal(encoded, metadata)
	return metadata, errors.Wrap(err, "error unmarshalling BlockMetadata")
}
