...
func (c *Components) ConfigTxGen() string {
	return c.Build("github.com/npci/drunix/cmd/configtxgen")
}

func (c *Components) Cryptogen() string {
	return c.Build("github.com/npci/drunix/cmd/cryptogen")
}

func (c *Components) Discover() string {
	return c.Build("github.com/npci/drunix/cmd/discover")
}
...
func (c *Components) Orderer() string {
	return c.Build("github.com/npci/drunix/cmd/orderer")
}

func (c *Components) Osnadmin() string {
	return c.Build("github.com/npci/drunix/cmd/osnadmin")
}

func (c *Components) Peer() string {
	return c.Build("github.com/npci/drunix/cmd/peer")
}
