...
import (
	...
	deliver_mocks "github.com/npci/drunix/common/deliver/mock"
	...
	cluster_mocks "github.com/npci/drunix/orderer/common/cluster/mocks"
	"github.com/npci/drunix/orderer/common/localconfig"
	onboarding_mocks "github.com/npci/drunix/orderer/common/onboarding/mocks"
...
func TestMain(m *testing.M) {
	var err error
	configtxgen, err = gexec.Build("github.com/npci/drunix/cmd/configtxgen")
	if err != nil {
