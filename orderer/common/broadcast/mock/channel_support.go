...
type ChannelSupport struct {
	...
	BatchConfigureStub        func(*common.Envelope, uint64) error
	batchConfigureMutex       sync.RWMutex
	batchConfigureArgsForCall []struct {
		arg1 *common.Envelope
		arg2 uint64
	}
	batchConfigureReturns struct {
		result1 error
	}
	batchConfigureReturnsOnCall map[int]struct {
		result1 error
	}
	BatchOrderStub        func(*common.Envelope, uint64) error
	batchOrderMutex       sync.RWMutex
	batchOrderArgsForCall []struct {
		arg1 *common.Envelope
		arg2 uint64
	}
	batchOrderReturns struct {
		result1 error
	}
	batchOrderReturnsOnCall map[int]struct {
		result1 error
	}
...
func (fake *ChannelSupport) BatchConfigure(arg1 *common.Envelope, arg2 uint64) error {
	fake.batchConfigureMutex.Lock()
	ret, specificReturn := fake.batchConfigureReturnsOnCall[len(fake.batchConfigureArgsForCall)]
	fake.batchConfigureArgsForCall = append(fake.batchConfigureArgsForCall, struct {
		arg1 *common.Envelope
		arg2 uint64
	}{arg1, arg2})
	fake.recordInvocation("BatchConfigure", []interface{}{arg1, arg2})
	fake.batchConfigureMutex.Unlock()
	if fake.BatchConfigureStub != nil {
		return fake.BatchConfigureStub(arg1, arg2)
	}
	if specificReturn {
		return ret.result1
	}
	fakeReturns := fake.batchConfigureReturns
	return fakeReturns.result1
}

func (fake *ChannelSupport) BatchOrder(arg1 *common.Envelope, arg2 uint64) error {
	fake.batchOrderMutex.Lock()
	ret, specificReturn := fake.batchOrderReturnsOnCall[len(fake.batchOrderArgsForCall)]
	fake.batchOrderArgsForCall = append(fake.batchOrderArgsForCall, struct {
		arg1 *common.Envelope
		arg2 uint64
	}{arg1, arg2})
	fake.recordInvocation("BatchOrder", []interface{}{arg1, arg2})
	fake.batchOrderMutex.Unlock()
	if fake.BatchOrderStub != nil {
		return fake.BatchOrderStub(arg1, arg2)
	}
	if specificReturn {
		return ret.result1
	}
	fakeReturns := fake.batchOrderReturns
	return fakeReturns.result1
}
...
func (fake *ChannelSupport) Invocations() map[string][][]interface{} {
	...
	fake.waitReadyMutex.RLock()
	defer fake.waitReadyMutex.RUnlock()
	fake.batchConfigureMutex.RLock()
	defer fake.batchConfigureMutex.RUnlock()
	fake.batchOrderMutex.RLock()
	defer fake.batchOrderMutex.RUnlock()
