...
import (
	...
	bccsp "github.com/npci/drunix/bccsp/factory"
...
type FileLedger struct {
	...
	KVStore           string
	OrgBlockCacheSize uint64
	KVStoreCacheSize  uint64
}
...
var Defaults = TopLevel{
	General: General{
		...
		Drunix: Drunix{
			MvccEnabled:      false,
			BlockCutTime:     comm.DefaultBlockCutTime,
			MaxBatchSize:     comm.DefaultMaxBatchSize,
			FollowerBatching: false,
		},
	},
	FileLedger: FileLedger{
...
func (c *TopLevel) completeInitialization(configDir string) {
	...
	for {
		...
		case c.General.Drunix.MaxBatchSize == 0:
			c.General.Drunix.MaxBatchSize = Defaults.General.Drunix.MaxBatchSize
		case c.General.Drunix.BlockCutTime == 0:
			c.General.Drunix.BlockCutTime = Defaults.General.Drunix.BlockCutTime
