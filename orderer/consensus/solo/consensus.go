...
// Function impl to satisfy the interface
func (ch *chain) BatchConfigure(_ *cb.Envelope, _ uint64) error {
	panic("solo does not support BatchConfigure")
}

// Function impl to satisfy the interface
func (ch *chain) BatchOrder(_ *cb.Envelope, _ uint64) error {
	panic("solo does not support BatchOrder")
}
