...
// BatchConfigure implements consensus.Chain.
func (chain *chainImpl) BatchConfigure(_ *cb.Envelope, _ uint64) error {
	panic("unimplemented")
}

// BatchOrder implements consensus.Chain.
func (chain *chainImpl) BatchOrder(_ *cb.Envelope, _ uint64) error {
	panic("unimplemented")
}
