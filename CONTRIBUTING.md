...
```
TEST_PKGS=github.com/npci/drunix/core/chaincode/... ./scripts/run-unit-tests.sh
```
...
- for mockery the command is `mockery --name ApplicationCapabilities --dir ~/github.com/npci/drunix/common/channelconfig --filename application_capabilities.go`
