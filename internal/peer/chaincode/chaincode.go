...
import (
	...
	"github.com/npci/drunix/internal/peer/packaging"
...
func resetFlags() {
	...
	flags.StringVar(&sqlSchema, "sql-config", "", "The fully qualified path to the sql schema  file including the file name")
