...
import (
	...
	ledgera "github.com/npci/drunix/common/ledger"
...
type PeerLedger struct {
	...
	CommitLegacyLtxStub        func(*ledger.BlockAndPvtData, *ledger.CommitOptions) error
	commitLegacyLtxMutex       sync.RWMutex
	commitLegacyLtxArgsForCall []struct {
		arg1 *ledger.BlockAndPvtData
		arg2 *ledger.CommitOptions
	}
	commitLegacyLtxReturns struct {
		result1 error
	}
	commitLegacyLtxReturnsOnCall map[int]struct {
		result1 error
	}
...
func (fake *PeerLedger) Invocations() map[string][][]interface{} {
	...
	fake.txIDExistsMutex.RLock()
	defer fake.txIDExistsMutex.RUnlock()
	fake.commitLegacyLtxMutex.RLock()
	defer fake.commitLegacyLtxMutex.RUnlock()
...
func (fake *PeerLedger) CommitLegacyLtx(arg1 *ledger.BlockAndPvtData, arg2 *ledger.CommitOptions) error {
	fake.commitLegacyLtxMutex.Lock()
	ret, specificReturn := fake.commitLegacyLtxReturnsOnCall[len(fake.commitLegacyLtxArgsForCall)]
	fake.commitLegacyLtxArgsForCall = append(fake.commitLegacyLtxArgsForCall, struct {
		arg1 *ledger.BlockAndPvtData
		arg2 *ledger.CommitOptions
	}{arg1, arg2})
	fake.recordInvocation("CommitLegacyLtx", []interface{}{arg1, arg2})
	fake.commitLegacyLtxMutex.Unlock()
	if fake.CommitLegacyLtxStub != nil {
		return fake.CommitLegacyLtxStub(arg1, arg2)
	}
	if specificReturn {
		return ret.result1
	}
	fakeReturns := fake.commitLegacyLtxReturns
	return fakeReturns.result1
}

func (fake *PeerLedger) CommitLegacyLtxCallCount() int {
	fake.commitLegacyLtxMutex.RLock()
	defer fake.commitLegacyLtxMutex.RUnlock()
	return len(fake.commitLegacyLtxArgsForCall)
}

func (fake *PeerLedger) CommitLegacyLtxCalls(stub func(*ledger.BlockAndPvtData, *ledger.CommitOptions) error) {
	fake.commitLegacyLtxMutex.Lock()
	defer fake.commitLegacyLtxMutex.Unlock()
	fake.CommitLegacyLtxStub = stub
}

func (fake *PeerLedger) CommitLegacyLtxArgsForCall(i int) (*ledger.BlockAndPvtData, *ledger.CommitOptions) {
	fake.commitLegacyLtxMutex.RLock()
	defer fake.commitLegacyLtxMutex.RUnlock()
	argsForCall := fake.commitLegacyLtxArgsForCall[i]
	return argsForCall.arg1, argsForCall.arg2
}

func (fake *PeerLedger) CommitLegacyLtxReturns(result1 error) {
	fake.commitLegacyLtxMutex.Lock()
	defer fake.commitLegacyLtxMutex.Unlock()
	fake.CommitLegacyLtxStub = nil
	fake.commitLegacyLtxReturns = struct {
		result1 error
	}{result1}
}

func (fake *PeerLedger) CommitLegacyLtxReturnsOnCall(i int, result1 error) {
	fake.commitLegacyLtxMutex.Lock()
	defer fake.commitLegacyLtxMutex.Unlock()
	fake.CommitLegacyLtxStub = nil
	if fake.commitLegacyLtxReturnsOnCall == nil {
		fake.commitLegacyLtxReturnsOnCall = make(map[int]struct {
			result1 error
		})
	}
	fake.commitLegacyLtxReturnsOnCall[i] = struct {
		result1 error
	}{result1}
}
