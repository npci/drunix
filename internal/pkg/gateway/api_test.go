...
import (
	...
	ledgermocks "github.com/npci/drunix/internal/pkg/gateway/ledger/mocks"
	"github.com/npci/drunix/internal/pkg/gateway/mocks"
	idmocks "github.com/npci/drunix/internal/pkg/identity/mocks"
...
func prepareTest(t *testing.T, tt *testDef) *preparedTest {
	...
	server := newServer(localEndorser, disc, mockFinder, mockPolicy, mockLedgerProvider, member, "msp1", &comm.SecureOptions{}, options, nil, tt.ordererEndpointOverrides, nil, nil)
